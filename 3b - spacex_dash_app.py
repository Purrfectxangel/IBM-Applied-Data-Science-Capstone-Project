...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        pie = px.pie(filtered_df, values='class', 
        names='Launch Sites', 
        ...
        pie = px.pie(selected_df, values='class', 
        names='Launch Site', 
        title='Outcomes for Selected Site')
        return pie
...
def get_scatter_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        scatter = px.pie(filtered_df, x = "Payload Mass (kg)", y = "class",
        color="Booster Version Category",
